...
#declare windowHeight = 1035 - 2 * skirtWidth;

#declare roomWidth = 1720 ;
#declare roomLength = 2050 ;
...
#declare shBaseLength = 900 ;
#declare shGlassHeight = 2000 ;

#declare doorHeight = 2030 - 2 * skirtWidth ;
#declare doorWidth  = 860  - 2 * skirtWidth; 

#declare shGlass1Length = shBaseLength  ;
